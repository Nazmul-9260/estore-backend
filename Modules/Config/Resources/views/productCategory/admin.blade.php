            ...
            <div class="col-lg-12">
                <div class="card mt-3">
                    <div class="card-header">
                        <h5>View All Product Category</h5>
                    </div>
                    <div class="card-body">
...
<script src="{{url('dataTable')}}/js/dataTables.bootstrap4.min.js"></script>
    ...
    <script>
        ...
        $('.data-table').DataTable({
            ...
            ajax: '{{ url('config/productCategory/admin') }}',
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $('#saveBtn').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ url('config/productCategory/create') }}",
                type: "POST",
                dataType: 'json',
        ...
        $('body').on('click', '.editData', function() {
            ...
            $.get("{{ url('config/productCategory/edit') }}" + '/' + dataId, function(data) {
        ...
        $('#updateBtn').click(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ url('config/productCategory/update') }}",
                type: "POST",
                dataType: 'json',
                success: function(data) {
        ...
        $('body').on('click', '.deleteData', function() {
            ...
            if (confirm("Are You sure want to delete !")) {
                $.ajax({
                    type: "GET",
                    url: "{{ url('config/productCategory/delete') }}" + '/' + data_id,
                    success: function(data) {
                        $('.dataTable').DataTable().ajax.reload(null, false);
                    },
                    error: function(data) {
