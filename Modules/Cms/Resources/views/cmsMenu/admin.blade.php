                        ...
                        <table class="table table-hover table-bordered data-table dataTable-store">
                            <thead>
                                <tr>
                                    ...
                                    <th>Ordering</th>
                                    <th>Status</th>
                                    <th class="col-action" width='150px'>Action</th>
                                </tr>
                            </thead>
                            <tfoot>
                                <tr>
                ...
                <form id="dataForm" name="dataForm" class="form-horizontal">
                    <div class="row">
                        <div class="col-md-6 pr-0">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select class="form-control" name="parent_id" id="parent_id">
                                        @php
                                        echo Modules\Cms\Entities\CmsMenu::getDropDownList('title');
                                        @endphp
                                    </select>
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Menu Name<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Icon Text<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="icon_text" name="icon_text"
                                        placeholder="Enter Icon Text" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 pl-0">
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Menu Position</label>
                                <div class="col-sm-12">
                                    <select class="form-control" id="position" name="position">
                                        @php
                                        echo Modules\Config\Entities\Config::dropDownList('menu_position');
                                        @endphp
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">URL<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Ordering</label>
                                <div class="col-sm-12">
            ...
            <div class="modal-body">
                <form id="dataFormUpdate" name="dataFormUpdate" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-md-6 pr-0">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <select class="form-control" name="parent_id" id="parent_id2">
                                        @php
                                        echo Modules\Cms\Entities\CmsMenu::getDropDownList('title');
                                        @endphp
                                    </select>
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Icon Text<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="icon_text2" name="icon_text"
                                        placeholder="Enter Icon Text" required>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6 pl-0">
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Menu Position<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-sm-12 control-label">Ordering</label>
                                <div class="col-sm-12">
                                    <select class="form-control" id="ordering2" name="ordering">
                                        @php
                                        echo Modules\Config\Entities\Config::dropDownList('ordering');
                                        @endphp
                                    </select>
...
<script>
    ...
    $('body').on('click', '.editData', function () {
        ...
        $.get("{{ url('cms/cmsMenu/edit') }}" + '/' + dataId, function (data) {
            $('#data_id').val(data.data.id);
            $('#modelHeadingUpdate').html("Edit Menu");
            $('#updateBtn').val("edit-menu");
            $('#ajaxModelUpdate').modal('show');
            $('#title2').val(data.data.title);
            $('#icon_text2').val(data.data.icon_text);
            $('#position2').val(data.data.position);
            $('#ordering2').val(data.data.ordering);
            $('#url2').val(data.data.url);
            $('#parent_id2').html(data.str);
    ...
    $('body').on('click', '.deleteData', function () {
        ...
        if (confirm("Are You sure want to delete !")) {
            $.ajax({
                type: "GET",
                url: "{{ url('cms/cmsMenu/delete') }}" + '/' + data_id,
                success: function (data) {
                    $('.dataTable').DataTable().ajax.reload(null, false);
                },
                error: function (data) {
