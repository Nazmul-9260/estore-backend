...
<div class="page-body custom-main-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="fom-estore" method="POST" action="{{url('acl/modules/'. $module->id)}}">
                @csrf
                @method('PUT')
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-default">
                                        ...
                                        <input name="name" class="form-control fill @error('name') form-control-danger @enderror" type="text" value="{{$module->name}}">
