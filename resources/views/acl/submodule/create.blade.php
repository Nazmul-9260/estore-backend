...
<div class="page-body custom-main-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-estore" method="POST" action="{{url('acl/submodules')}}">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h5>Create New Submodule</h5>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group form-default">
                                        ...
                                        <input name="name" Placeholder="Submodule Name" class="form-control @error('name') form-control-danger @enderror" type="text" value="{{old('name')}}">
