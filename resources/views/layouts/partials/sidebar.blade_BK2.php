     ...
     <div class="pcoded-inner-navbar main-menu">
         ...
         <ul class="pcoded-item pcoded-left-item">
             <li class="pcoded-hasmenu">
                 ...
                 <ul class="pcoded-submenu">
                     <li class=" ">
                         <a href="{{url('/patient-profile')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                             <span class="pcoded-mtext">Patient Profile</span>
                             <span class="pcoded-mcaret"></span>
                         </a>
                     </li>
                     <li class=" ">
                         <a href="{{url('/patient-dashboard')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                             <span class="pcoded-mtext">Patient Dashboard</span>
                             <span class="pcoded-mcaret"></span>
                         </a>
                     </li>

                     <li class=" ">
                         <a href="{{url('/login-via-phone')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                             <span class="pcoded-mtext">Login Via Phone</span>
                             <span class="pcoded-mcaret"></span>
                         </a>
                     </li>

                     <li class=" ">
                         <a href="{{url('/admin-dashboard-1')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                     ...
                     <li class=" ">
                         <a href="{{url('/admin-dashboard-2')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                     ...
                     <li class=" ">
                         <a href="{{url('/admin-dashboard-3')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                     ...
                     <li class=" ">
                         <a href="{{url('/admin-dashboard-4')}}" class="waves-effect waves-dark">
                             <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                             <span class="pcoded-mtext">Dashboard 4</span>
                             <span class="pcoded-mcaret"></span>
                         </a>
                     </li>
                     <li class=" ">
